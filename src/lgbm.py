...
# HPO budget on train/val pipeline.
HPO_N_TRIALS = 40
HPO_N_INIT = 10
...
def load_optional_radiomics_split(name: str):
    ...
    for fp in files:
        ...
        # Drop radiomics metadata columns; keep only numeric radiomics descriptors.
...
def tune_lgbm_bayes(
    X_tr, y_tr, X_va, y_va, focus_ids, n_trials=40, n_init=10, seed=42
):
